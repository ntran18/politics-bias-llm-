...
def get_assessment_model(include_explanation: bool, include_cot: bool = False):
    if include_cot:
        return PoliticalBiasAssessmentWithCoT
    return PoliticalBiasAssessment if include_explanation else PoliticalBiasAssessmentNoExplanation
